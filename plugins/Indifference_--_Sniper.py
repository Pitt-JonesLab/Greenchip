...
#path_to_output_directory = OurConstants.get_path_to_output_dir()
...
class config(object):
    ...
    def plot(self, *args):
        ...
        utils.make_single_plot(self, first_entry, second_entry, self.entry1.get(), self.entry2.get(), res, 'Indifference Plot Energy')
