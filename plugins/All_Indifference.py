from tkinter import *
from plugins.shared.Utils import utils, OurConstants
...
class config(object):
    ...
    def plot(self, *args):
        ...
        first_entry = utils.build_config(self.DB, self.entry1, self.path_to_output_directory)
        second_entry = utils.build_config(self.DB, self.entry2, self.path_to_output_directory)
        config_dicts = []
        ...
        utils.make_plot(self, first_entry, second_entry, self.entry1, self.entry2, res, "IP", self.path_to_output_directory)
