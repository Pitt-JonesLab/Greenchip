...
class config(object):
    ...
    def plot(self, *args):
        ...
        if self.varE.get()==1:
            ...
            utils.make_single_plot(self, first_entry, second_entry, self.entry1.get(), self.entry2.get(), res, 'Breakeven Plot Energy', self.increment, self.mindays, self.maxdays, self.minyears, self.maxyears)
        if self.varC.get()==1:
            ...
            utils.make_single_plot(self, first_entry, second_entry, self.entry1.get(), self.entry2.get(), res, 'Breakeven Plot Carbon', self.increment, self.mindays, self.maxdays, self.minyears, self.maxyears)
